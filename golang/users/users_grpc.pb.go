...
func (c *usersClient) RegisterUser(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
func (UnimplementedUsersServer) RegisterUser(context.Context, *RegisterRequest) (*UserResponse, error) {
